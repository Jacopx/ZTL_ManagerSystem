...
import it.polito.dp2.RNS.sol2.CustomErrorHandler;
...
public class JsonValidationInterceptor implements ReaderInterceptor {
  private final String jaxbPackage = "it.polito.dp2.RNS.sol3.rest.service.jaxb";
  ...
  public void validate(Object item) {
    try {
      ...
      v.setErrorHandler(new CustomErrorHandler());
      v.validate(source);
